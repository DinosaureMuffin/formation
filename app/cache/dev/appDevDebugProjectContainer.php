...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'hip_mandrill.client' => 'getHipMandrill_ClientService',
            'hip_mandrill.dispatcher' => 'getHipMandrill_DispatcherService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => 5432, 'dbname' => 'FormationSymfony', 'user' => 'postgres', 'password' => 'IaDfrance', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Iad/Bundle/TrainingBundle/Entity'))), 'Iad\\Bundle\\TrainingBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('IadTrainingBundle' => 'Iad\\Bundle\\TrainingBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9aea706fc42241ed15a4fda5050bb5d38aeae08255428af79549836415d2d004');
    ...
    /**
     * Gets the 'hip_mandrill.client' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mandrill A Mandrill instance.
     */
    protected function getHipMandrill_ClientService()
    {
        return $this->services['hip_mandrill.client'] = new \Mandrill('sN0TG8b_JHq6xYhabDoLzw');
    }

    /**
     * Gets the 'hip_mandrill.dispatcher' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Hip\MandrillBundle\Dispatcher A Hip\MandrillBundle\Dispatcher instance.
     */
    protected function getHipMandrill_DispatcherService()
    {
        return $this->services['hip_mandrill.dispatcher'] = new \Hip\MandrillBundle\Dispatcher($this->get('hip_mandrill.client'), 'test@iadfrance.fr', 'IaDFrance', NULL, false, array('use' => false, 'host' => NULL, 'port' => NULL, 'user' => NULL, 'password' => NULL));
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'/vendor/symfony/assetic-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'AppBundle' => ($this->targetDirs[3].'/src/AppBundle/Resources/config/serializer'), 'Iad\\Bundle\\TrainingBundle' => ($this->targetDirs[3].'/src/Iad/Bundle/TrainingBundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/FOS/RestBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'Hip\\MandrillBundle' => ($this->targetDirs[3].'/vendor/hipaway-travel/mandrill-bundle/Hip/MandrillBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Sensio/Bundle/GeneratorBundle/Resources/config/serializer')));
    ...
    /**
     * Gets the 'say_hello' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Iad\Bundle\TrainingBundle\Business\BusinessTrainingService A Iad\Bundle\TrainingBundle\Business\BusinessTrainingService instance.
     */
    protected function getSayHelloService()
    {
        return $this->services['say_hello'] = new \Iad\Bundle\TrainingBundle\Business\BusinessTrainingService();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Iad/Bundle/TrainingBundle/Resources/views'), 'IadTraining');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('55f038363f2384.63572501')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'IadTrainingBundle' => 'Iad\\Bundle\\TrainingBundle\\IadTrainingBundle',
                'FOSRestBundle' => 'FOS\\RestBundle\\FOSRestBundle',
                'JMSSerializerBundle' => 'JMS\\SerializerBundle\\JMSSerializerBundle',
                'HipMandrillBundle' => 'Hip\\MandrillBundle\\HipMandrillBundle',
            ...
            'database_port' => 5432,
            'database_name' => 'FormationSymfony',
            'database_user' => 'postgres',
            'database_password' => 'IaDfrance',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'mandrillapp_key' => 'sN0TG8b_JHq6xYhabDoLzw',
            'mandrill_sender' => 'test@iadfrance.fr',
            'mandrill_sender_name' => 'IaDFrance',
            'locale' => 'en',
            ...
            'hip_mandrill.api_key' => 'sN0TG8b_JHq6xYhabDoLzw',
            'hip_mandrill.disable_delivery' => false,
            'hip_mandrill.default.sender' => 'test@iadfrance.fr',
            'hip_mandrill.default.sender_name' => 'IaDFrance',
            'hip_mandrill.default.subaccount' => NULL,
            'hip_mandrill.proxy' => array(
                'use' => false,
                'host' => NULL,
                'port' => NULL,
                'user' => NULL,
